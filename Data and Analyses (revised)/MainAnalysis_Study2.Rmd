...
#added leo
dat <- rio::import("Data and Analyses (revised)/Study2.sav") #added leo (setting link)
...
lavaan::fitmeasures(fit.conf.long,"srmr") #add leo
lavaan::fitmeasures(fit.conf.long,"rmsea") #add leo
lavaan::fitmeasures(fit.conf.long,"cfi") #add leo
...
lavaan::fitmeasures(fit.lcsm,"srmr") #add leo
lavaan::fitmeasures(fit.lcsm,"rmsea") #add leo
lavaan::fitmeasures(fit.lcsm,"cfi") #add leo
```
